...
df_value= pandas.read_csv('Hard Value.csv')
df_policy= pandas.read_csv('Hard Policy.csv')
df_Q = pandas.read_csv('Hard Q-Learning L0.1 q1.0 E0.3.csv')

title  = 'Hard Problem Time by Algorithm'
plot = plot_learning_curve(df_value, df_policy, df_Q, title)
plot.savefig(title+ '.png')
plot.close()


title  = 'Hard Problem Reward by Algorithm'
plot = plot_mse(df_value, df_policy, df_Q, title)
plot.savefig(title+ '.png')
plot.close()

title  = 'Hard Problem Steps by Algorithm'
plot = plot_timing_curve(df_value, df_policy, df_Q, title)
plot.savefig(title+ '.png')
plot.close()


title  = 'Hard Problem Convergence by Algorithm'
