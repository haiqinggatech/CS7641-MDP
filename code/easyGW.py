...
#    Print the map that is being analyzed
    ...
    if True:
        ...
        for nIter in iterations:      
            ...
            if nIter == 2 or nIter == 5 or nIter == 10 or vi.latestDelta < 1e-4:
    ...
    if True:
        ...
        for nIter in iterations: 
            ...
            if nIter == 10 or nIter == 50 or nIter == 500 or nIter == 1000 or nIter == 2000 or nIter == 3000 or nIter == 4000 or nIter == 5000:
